...
export const seedState: AppState = {
  projects: [
    { id:'p1',  client:'House Athol',       location:'Athol, Johannesburg',      product:'Custom Indoor Sauna + Cold Plunge',       type:'sauna',        value:285000, status:'in-progress', progress:60, stage:'Cladding',       manager:'Ari', startDate:'2026-03-15', endDate:'2026-06-30' },
    { id:'p2',  client:'House Constantia',  location:'Constantia, Cape Town',    product:'Wellness Pavilion + Outdoor Sauna',       type:'pavilion',     value:480000, status:'in-progress', progress:80, stage:'Electrical',     manager:'Ari', startDate:'2026-02-01', endDate:'2026-06-15' },
    { id:'p3',  client:'Moove Sandton',     location:'Sandton, Johannesburg',    product:'Commercial Ice Bath Suite (×6)',           type:'cold-plunge',  value:380000, status:'in-progress', progress:70, stage:'Plumbing',       manager:'Ari', startDate:'2026-04-01', endDate:'2026-07-01' },
    { id:'p4',  client:'House Val de Vie',  location:'Val de Vie, Paarl',        product:'Outdoor Sauna + Cold Plunge + Pergola',   type:'sauna',        value:265000, status:'in-progress', progress:45, stage:'Framing',        manager:'Ari', startDate:'2026-04-20', endDate:'2026-07-15' },
    { id:'p5',  client:'House Bakoven',     location:'Bakoven, Cape Town',       product:'Custom Outdoor Sauna (Thermory)',          type:'sauna',        value:195000, status:'in-progress', progress:35, stage:'Foundation',     manager:'Ari', startDate:'2026-05-01', endDate:'2026-07-30' },
    { id:'p6',  client:'House Noordhoek',   location:'Noordhoek, Cape Town',     product:'Cold Plunge + Hot Tub Combo',             type:'hot-tub',      value:225000, status:'in-progress', progress:25, stage:'Foundation',     manager:'Ari', startDate:'2026-05-15', endDate:'2026-08-01' },
    { id:'p7',  client:'House Steenberg',   location:'Steenberg, Cape Town',     product:'Custom Indoor Sauna (Huum Drop)',          type:'sauna',        value:185000, status:'qa',          progress:95, stage:'Final Handover', manager:'Ari', startDate:'2026-02-10', endDate:'2026-06-20' },
    { id:'p8',  client:'House Camps Bay',   location:'Camps Bay, Cape Town',     product:'Outdoor Hot Tub + Sauna Combo',           type:'hot-tub',      value:310000, status:'qa',          progress:90, stage:'Snag List',      manager:'Ari', startDate:'2026-01-20', endDate:'2026-06-10' },
    { id:'p9',  client:'Silvan Lodge',      location:'Kruger, Limpopo',          product:'Commercial Wellness Suite',               type:'steam',        value:680000, status:'planning',    progress:0,  stage:'Design',         manager:'Ari', startDate:'2026-07-01', endDate:'2026-10-15' },
    { id:'p10', client:'House Clifton',     location:'Clifton, Cape Town',       product:'Indoor Sauna + Steam Room',               type:'steam',        value:320000, status:'planning',    progress:0,  stage:'Proposal',       manager:'Ari', startDate:'2026-07-10', endDate:'2026-09-30' },
    { id:'p11', client:'House Morningside', location:'Morningside, Jhb',         product:'Custom Indoor Sauna (Tulikivi)',           type:'sauna',        value:210000, status:'planning',    progress:0,  stage:'Quote',          manager:'Ari', startDate:'2026-07-20', endDate:'2026-10-01' },
    { id:'p12', client:'House Bishopcourt', location:'Bishopcourt, Cape Town',   product:'Cold Plunge Installation',                type:'cold-plunge',  value:145000, status:'complete',    progress:100,stage:'Handed Over',    manager:'Ari', startDate:'2026-01-10', endDate:'2026-03-15' },
    { id:'p13', client:'House Hout Bay',    location:'Hout Bay, Cape Town',      product:'Outdoor Sauna (Ark Pergola)',              type:'sauna',        value:165000, status:'complete',    progress:100,stage:'Handed Over',    manager:'Ari', startDate:'2025-11-01', endDate:'2026-02-28' },
    { id:'p14', client:'Black Sable',       location:'Constantia, Cape Town',    product:'Commercial Wellness: Sauna + Cold Plunge', type:'cold-plunge', value:420000, status:'complete',    progress:100,stage:'Handed Over',    manager:'Ari', startDate:'2025-10-01', endDate:'2026-02-01' },
    { id:'p15', client:'House Stellenbosch',location:'Stellenbosch, WC',         product:'Indoor Sauna (Huum Cube)',                 type:'sauna',        value:175000, status:'complete',    progress:100,stage:'Handed Over',    manager:'Ari', startDate:'2026-01-05', endDate:'2026-04-10' },
  ],
